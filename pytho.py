...
class ToDoApp(tk.Tk):
    def __init__(self):
        ...
        self.configure(bg="skyblue")  # Set background color
    ...
    def create_widgets(self):
        self.task_listbox = tk.Listbox(self, width=80, height=15, font=("Arial", 12), selectbackground="red", selectmode=tk.SINGLE)
        self.task_listbox.pack(pady=10, padx=10)

        self.refresh_tasks()

        add_button = tk.Button(self, text="Add Task", command=self.add_task, font=("Arial", 12), bg="blue", fg="black")
        add_button.pack(pady=5)

        remove_button = tk.Button(self, text="Remove Task", command=self.remove_task, font=("Arial", 12), bg="red", fg="black")
        remove_button.pack(pady=5)

        complete_button = tk.Button(self, text="Mark as Completed", command=self.mark_completed, font=("Arial", 12), bg="pink", fg="black")
